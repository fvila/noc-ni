...
add wave -noupdate -format Literal /testbench_ni/i1/slv0/htrans
add wave -noupdate -format Logic /testbench_ni/i1/slv0/inc
...
add wave -noupdate -format Literal /testbench_ni/i1/pkt0/pkt_out
...
update
WaveRestoreZoom {700250 ps} {805250 ps}
